...
if __name__ == '__main__':
    ...
    cifar=Model(batch_size=100,lr=0.0001,dataSet=dataSet,weight_decay=0.0)
    neure=[1000]
    #neure=[2000]
    batch_size=100
    ...
    cifar.add(SoftmaxLayer(neure[0],5))
    cifar.build_train_fn()
    cifar.build_vaild_fn()
    algorithm=Mini_Batch(model=cifar,n_epochs=200,load_param='params/1NN1000_ROT.pkl',save_param='mlp_params.pkl')
    algorithm.run()